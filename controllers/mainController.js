    ...
    request(
        ...
        function (error, response, body) {
            ...
            const json = {
                ...
                "Password": new Buffer.from(`${configs.shortcode}${configs.online_checkout_passkey}${timestamp}`).toString("base64"),
                "Timestamp": timestamp,
                ...
                "AccountReference": "TestfromDerrick", // TODO 
                "TransactionDesc": "Testing from Derrick" // TODO 
            };
